...
const CoursePage = () => {
    const [isSidebarOpen, setIsSidebarOpen] = useState(true); // Start open for desktop
    const [isDropdownOpen, setIsDropdownOpen] = useState(false); // Add dropdown state

    const toggleSidebar = () => {
        setIsSidebarOpen(!isSidebarOpen); // Simplified toggle
    };

    const toggleDropdown = () => {  // Add toggle function
        ...
        <div className={styles.container}>
            <div className={styles.menuContainer}>
                <button onClick={toggleSidebar} className={styles.menuToggle}>
                    {isSidebarOpen ? <FaTimes className={styles.menuIcon} /> : <FaBars className={styles.menuIcon} />}
                </button>
            </div>

            {isSidebarOpen && ( // Use conditional rendering
